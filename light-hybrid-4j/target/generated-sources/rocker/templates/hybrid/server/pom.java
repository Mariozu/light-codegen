...
/*
 * Auto generated code to render template templates/hybrid/server/pom.xml.rocker.raw
...
public class pom extends com.fizzed.rocker.runtime.DefaultRockerModel {
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        protected void __doRender() throws IOException, RenderingException {
            ...
            // IfBlockBegin @ [126:9]
            __internal.aboutToExecutePosInTemplate(126, 9);
            if (config.toBoolean("supportDb") || config.toBoolean("supportH2ForTest")) {
                // PlainText @ [126:84]
                __internal.aboutToExecutePosInTemplate(126, 84);
                __internal.writeValue(PLAIN_TEXT_12_0);
                // IfBlockEnd @ [126:9]
                __internal.aboutToExecutePosInTemplate(126, 9);
            } // if end @ [126:9]
            // PlainText @ [132:10]
            __internal.aboutToExecutePosInTemplate(132, 10);
            __internal.writeValue(PLAIN_TEXT_6_0);
            // IfBlockBegin @ [133:9]
            __internal.aboutToExecutePosInTemplate(133, 9);
            if (config.toBoolean("supportDb") && "oracle".equalsIgnoreCase(config.toString("dbInfo", "name"))) {
                // PlainText @ [133:108]
                __internal.aboutToExecutePosInTemplate(133, 108);
                __internal.writeValue(PLAIN_TEXT_13_0);
                // IfBlockEnd @ [133:9]
                __internal.aboutToExecutePosInTemplate(133, 9);
            } // if end @ [133:9]
            // PlainText @ [139:10]
            __internal.aboutToExecutePosInTemplate(139, 10);
            __internal.writeValue(PLAIN_TEXT_6_0);
            // IfBlockBegin @ [140:9]
            __internal.aboutToExecutePosInTemplate(140, 9);
            if (config.toBoolean("supportDb") && "mysql".equalsIgnoreCase(config.toString("dbInfo", "name"))) {
                // PlainText @ [140:107]
                __internal.aboutToExecutePosInTemplate(140, 107);
                __internal.writeValue(PLAIN_TEXT_14_0);
                // IfBlockEnd @ [140:9]
                __internal.aboutToExecutePosInTemplate(140, 9);
            } // if end @ [140:9]
            // PlainText @ [146:10]
            __internal.aboutToExecutePosInTemplate(146, 10);
            __internal.writeValue(PLAIN_TEXT_6_0);
            // IfBlockBegin @ [147:9]
            __internal.aboutToExecutePosInTemplate(147, 9);
            if (config.toBoolean("supportDb") && "postgres".equalsIgnoreCase(config.toString("dbInfo", "name"))) {
                // PlainText @ [147:110]
                __internal.aboutToExecutePosInTemplate(147, 110);
                __internal.writeValue(PLAIN_TEXT_15_0);
                // IfBlockEnd @ [147:9]
                __internal.aboutToExecutePosInTemplate(147, 9);
            } // if end @ [147:9]
            // PlainText @ [153:10]
            __internal.aboutToExecutePosInTemplate(153, 10);
            __internal.writeValue(PLAIN_TEXT_16_0);
            // IfBlockBegin @ [161:9]
            __internal.aboutToExecutePosInTemplate(161, 9);
            if (config.toBoolean("supportH2ForTest")) {
                // PlainText @ [161:51]
                __internal.aboutToExecutePosInTemplate(161, 51);
                __internal.writeValue(PLAIN_TEXT_17_0);
                // IfBlockEnd @ [161:9]
                __internal.aboutToExecutePosInTemplate(161, 9);
            } // if end @ [161:9]
            // PlainText @ [168:10]
            __internal.aboutToExecutePosInTemplate(168, 10);
