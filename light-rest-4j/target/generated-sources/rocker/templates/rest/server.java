...
/*
 * Auto generated code to render template templates/rest/server.yml.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@Generated("com.fizzed.rocker.compiler.JavaGenerator") @SuppressWarnings("unused")
public class server extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public final com.fizzed.rocker.ContentType CONTENT_TYPE = com.fizzed.rocker.ContentType.RAW;
    static public final String TEMPLATE_NAME = "server.yml.rocker.raw";
    ...
    public server serviceId(String serviceId) {
    ...
    public server enableHttp(Boolean enableHttp) {
    ...
    public server httpPort(String httpPort) {
    ...
    public server enableHttps(Boolean enableHttps) {
    ...
    public server httpsPort(String httpsPort) {
    ...
    public server enableRegistry(Boolean enableRegistry) {
    ...
    static public server template(String serviceId, Boolean enableHttp, String httpPort, Boolean enableHttps, String httpsPort, Boolean enableRegistry) {
        return new server()
            .serviceId(serviceId)
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(server.class.getClassLoader(), server.class.getName() + "$PlainText", "UTF-8");
